...
def show_all_users(message):
    ...
    if user_id in admin_id:
        ...
        क्या तू सबका लंड अपनी गांड में डालेगा?
नहीं, तू अपनी माँ की गांड में डालेगा
और तुझे कहीं और भी डालना चाहिए।
क्या तू सबको देखना चाहता है?
अरे मादरचोद,
जब तू स्टूडेंट है तो मर क्यों रहा है?
        Will you put everyone's dick in your ass? 
        No, you will put it in your mother's ass
        and you should also put it somewhere else. 
        Do you want to see everyone?
        Hey motherfucking guy, 
        when you are a student then why are you dying?
        """
    bot.reply_to(message, response)
...
def start_attack_reply(message, TRUST_IP, TRUST_port, time):
    ...
    response = f"𝘿𝙃𝘼𝙉𝙔𝘼𝙑𝘼𝘿𝘼 𝙂𝙐𝙀𝙎𝙏 🎀\n\n𝖠𝖨𝖬:- 🏁: {TRUST_IP}\n𝖯𝖮𝖱𝖳:- 📉 {TRUST_port}\n𝖳𝖨𝖬𝖤:- ♨️ {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝙈𝘼𝘿𝙀 𝘽𝙔:- 🎫 𝚃𝚁𝚄𝚂𝚃\n\nसारज्ञः भव - 𝗕𝗘 𝗥𝗘𝗔𝗟𝗦𝗧𝗜𝗖 🖤\n   𝐃𝐄𝐕𝐋𝐎𝐏𝐄𝐑 :- @TRUSTVIP_MOD"
    bot.reply_to(message, response)
